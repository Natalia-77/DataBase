...
CREATE TABLE [dbo].[Employeers] (
	...
	IF NOT EXISTS (SELECT * FROM sys.tables WHERE object_id = OBJECT_ID(N'[dbo].[Productes]'))
EXEC dbo.sp_executesql @statement = N'
...
CREATE TABLE [dbo].[Orders] (
	...
	[ProductesId] INT NOT NULL FOREIGN KEY ([ProductesId]) REFERENCES [dbo].[Productes]([Id])
	)'
